...
// @namespace    https://github.com/star-dev-real
// @version      15.3
// @description  Blooket Cheats
// @updateURL    https://github.com/star-dev-real
// @downloadURL  https://github.com/star-dev-real
// @author       souuuulll
...
(async () => {
    ...
    if (console.log("%c Blooket Cheats Plus %c\n	By souuuulll on GitHub", "color: #0bc2cf; font-size: 3rem", "color: #8000ff; font-size: 1rem"), console.log("%c	Mobilegui.js", "color: #0bc2cf; font-size: 1rem"), console.log("%c	Star the github repo!%c  https://github.com/star-dev-real", "color: #ffd000; font-size: 1rem", ""), document.querySelector("script[src*='bfs/index.js']") && !window.clearId) {
        ...
        let c = document.createElement("div"),
            d = (t = document.createElement("div"), c.appendChild(t), a.appendChild(c), t.innerHTML = `<span id="curPageEl">${_(!0)?"Current gamemode: "+_(!0):"No game detected"}</span><br><span>(Press E to hide)</span><br>`, t.style.display = "block", t.style.margin = "10px", document.body.append(a), o = document.createElement("div"), c.appendChild(o), o.style.fontSize = "0.9rem", o.style.paddingBottom = "5px", {
                global: [{
                    ...
                    type: "toggle",
                    enabled: (o.innerHTML = '<span><a target="blank" href="https://discord.gg/Ddt3Gk647A">Discord</a><br/><a target="blank" href="https://github.com/star-dev-real/">GitHub - souuuulll</a></span>', !1),
                    data: null,
                    run: function() {
